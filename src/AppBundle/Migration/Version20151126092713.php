...
class Version20151126092713 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE my_user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(55) NOT NULL, salt VARCHAR(32) NOT NULL, password VARCHAR(60) NOT NULL, email VARCHAR(60) NOT NULL, is_active TINYINT(1) NOT NULL, password_reset_key VARCHAR(32) DEFAULT NULL, auto_login_key VARCHAR(32) NOT NULL, created_date DATETIME DEFAULT NULL, updated_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_4DB4FF1DF85E0677 (username), UNIQUE INDEX UNIQ_4DB4FF1DE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
